...
#include <iostream>
using namespace std;
>>>>>>> 1abe6c02a7868164381a413a47dcc98e53450b19
#include "sdl_aux.h"
...
extern double find_shiftMC3( user_params &p, int depth, int Ny);
extern bool is_ghost(SDL_Surface *depth_map, int x, int y, int ghost_threshold);
extern bool shift_surface ( user_params &p,
